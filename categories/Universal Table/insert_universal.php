...
<body>
  ...
  <?php if ($hasRecord): foreach ($rows as $r): ?>
    <form method="POST" action="/ItemPilot/categories/Universal Table/insert_universal.php" enctype="multipart/form-data" class="flex flex-wrap md:flex-nowrap items-center divide-x divide-gray-300 border-b border-gray-300">
