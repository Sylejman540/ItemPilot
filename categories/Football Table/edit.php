...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "UPDATE football_table SET table_title = ? WHERE table_id = ? AND user_id = ?";
...
$stmt = $conn->prepare("SELECT table_title FROM football_table WHERE table_id = ? AND user_id = ?");
