...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "UPDATE groceries_table SET table_title = ? WHERE table_id = ? AND user_id = ?";
...
$stmt = $conn->prepare("SELECT table_title FROM groceries_table WHERE table_id = ? AND user_id = ?");
